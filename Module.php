...
{
    public $controllerNamespace = 'zhangyc310\setting\controllers\frontend';
    ...
    public function init()
    {
        ...
        $this->setViewPath('@zhangyc310/setting/views');
    }
    ...
    {
        return Yii::t('zhangyc310/' . $category, $message, $params, $language);
    }
